...
# (Simon-CR, 2026-09-11): the stock states stay in the low nibble, bit 7
...
class AceProtocolV2(AceProtocol):
    ...
    def _method_to_v2(self, method, params):
        ...
        if method == 'drying':
            ...
            # whether a lane is threaded, parked or empty (Simon-CR,
            # 2026-09-11, from the stock binary). Default is the factory
    ...
    def _v2_response_to_v1(self, cmd, seq, payload):
        ...
        if cmd == Cmd.DISCOVER_DEVICE:
            ...
            # (2026-08-03): 8 = 175 and 9 = 330, which can only be the
